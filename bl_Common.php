...
const DATA_BASE_NAME = 'game';
const DATA_BASE_USER = 'dev_one';
const DATA_BASE_PASSWORLD = '12_jv1t8Z';
...
const ADMIN_EMAIL = 'admin@scroogeapi.com'; // email address from which the verification emails will be send.
const GAME_NAME = 'Degen City';
